    ...
    <div className="space-y-6 flex flex-col h-full animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 flex-1 min-h-0">
        ...
        <div className="md:col-span-2 flex flex-col gap-6">
          <div className="bg-bg-card rounded-lg border border-border-subtle p-6 flex flex-col sm:flex-row gap-6 shadow-sm">
            <div className="w-full sm:w-1/3 flex flex-col items-center justify-center">
              <h2 className="text-body-lg font-medium text-text-main mb-2 w-full text-center">Task Progress</h2>
            ...
            <div className="w-full sm:w-2/3 border-t sm:border-t-0 sm:border-l border-border-subtle pt-6 sm:pt-0 sm:pl-6 flex flex-col">
          ...
          <div className="bg-bg-card rounded-lg border border-border-subtle p-6 flex-1 shadow-sm flex flex-col">
            <h2 className="text-body-lg font-medium text-text-main mb-4 flex items-center gap-2">
        ...
        <div className="space-y-6">
          <div className="bg-bg-card rounded-lg border border-border-subtle p-6 shadow-sm">
            <h2 className="text-body-lg font-medium text-text-main mb-4">Quick Add</h2>
